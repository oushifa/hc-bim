      ...
      <div class="flex flex-wrap items-center gap-3">
        ...
        <div class="relative">
          <input
            ...
            type="text"
            placeholder="搜索模型..."
            class="search-input w-48 border border-gray-200 rounded-[8px] py-1.5 pl-3 pr-8 text-sm focus:outline-none text-[#333] transition-all"
            :class="searchQuery ? 'border-[#00b4b6] bg-white' : 'bg-gray-50'"
          />
