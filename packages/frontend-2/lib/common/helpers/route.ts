...
export const organizationRoute = '/organization'
export const permissionsRoute = '/permissions'
export const logsRoute = '/logs'
export const projectsRoute = '/projects'
export const modelsRoute = '/models'
export const lightModelsRoute = '/models/light'
export const twinModelsRoute = '/models/twin'
export const twinSceneRoute = '/twin-scene'
export const twinSceneWorkgroupRoute = (workgroupId?: string) =>
  workgroupId ? `/twin-scene/${workgroupId}` : '/twin-scene/workgroup-1'
export const twinSceneCasesRoute = (workgroupId?: string) =>
  workgroupId ? `/twin-scene/${workgroupId}/cases` : '/twin-scene/workgroup-1/cases'
export const twinSceneMembersRoute = (workgroupId?: string) =>
  workgroupId ? `/twin-scene/${workgroupId}/members` : '/twin-scene/workgroup-1/members'
export const twinSceneSettingsRoute = (workgroupId?: string) =>
  workgroupId
    ? `/twin-scene/${workgroupId}/settings`
    : '/twin-scene/workgroup-1/settings'
...
export const LearnMoreMoveProjectsUrl = '/pricing'
